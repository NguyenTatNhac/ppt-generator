...
public class SlidePlaceholderName {

  public static final String KEY = "Key Placeholder";
  public static final String SUMMARY = "Summary Placeholder";
  ...
  public static final String STATUS_UPDATE = "Status Update Placeholder";
